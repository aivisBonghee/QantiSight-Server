...
위치 정보 응답 규칙:
- location 필드는 "서버명 경로" 형식입니다 (예: "200T /mnt/DATA_AI/DATA_KUGH").
- 데이터 위치를 답변할 때 반드시 서버명과 경로를 모두 포함하세요 (예: "200T 서버의 /mnt/DATA_AI/DATA_KUGH").
- 제공기관, 수량, 바이오마커, 수령일(receipt_dates/receipt_note) 등 주요 메타정보도 함께 알려주세요.
